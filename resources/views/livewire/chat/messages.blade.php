                                    ...
                                    @foreach ($users as $user)
                                        @if ($user->id !== auth()->id())
                                            @php
                                                ...
                                                $lastMessage = App\Models\Message::where('user_id', $user->id)
                                                    ->where('receiver_id', auth()->id())
                                    ...
                                    @foreach ($allmessages as $msg)
                                        <div
                                            ...
                                            @if ($msg->user_id != auth()->id())
                                                @if ($sender->photo != '' || $sender->photo != null)
                                                    <img src="{{ asset('storage/' . $sender->photo) }}" alt="avatar 1"
                                                        class=" img rounded-circle ms-3 "
                                                        style="width: 45px; height: 100%;">
                                                @else
                                                    <img src="../assets/images/user.png" alt="avatar 1" class="ms-3 "
                                                        style="width: 45px; height: 100%;">
                                                @endif
                                            @endif
                                            <div>
                        ...
                        <div class="text-muted d-flex justify-content-start align-items-center pe-3 pt-3 mt-2">
                            ...
                            <form wire:submit.prevent="SendMessage" style="display: flex; width: 100%;">
                                ...
                                <button type="submit"
                                    ...
                                    style="height: 38px; height:38px;  background-color: #3949AB;">
