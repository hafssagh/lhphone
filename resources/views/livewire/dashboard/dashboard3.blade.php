                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h3 style="color:#4650dd; font-size: 1.24rem">{{ $cards[0] }} Rendez-vous
                                        </h3>
                            ...
                            <div class="card-footer py-3"
                                ...
                                <div class="row align-items-center  justify-content-center" style="color:#4650dd ">
                                    <div class="col-10">
                                        <p class="mb-0">
                                            <strong>
                                                <a href="/RG" style="text-decoration: none;color: inherit;">En
                                                    savoir
                                                    plus</a>
                                            </strong>
                                        </p>
                    ...
                    <div class="mb-4 col-sm-6 col-lg-3 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h3 class="text-danger" style="font-size: 1.26rem">{{ $cards[2] }}
                                            Rendez-vous
                                        </h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <p class="text-sm mb-0" style="color:white"> .</p>
                                    </div>
                            ...
                            <div class="card-footer py-3"
                                ...
                                <div class="row align-items-center justify-content-center" style="color:#835db4">
                                    <div class="col-10">
                                        <p class="mb-0">
                                            <strong><a href="/RG" style="text-decoration: none;color: inherit;">En
                                                    savoir
                                                    plus</a></strong>
                                        </p>
                                    </div>
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <div class="list-container1" style="  max-height: 300px;">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="padding: 1rem;" class="text-center text-muted">RDV(Jour)
                                            </th>
                                            <th style="padding: 1rem;" class="text-center text-muted">RDV(Mois)
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($users as $user)
                                            <tr>
                                                <td style="padding: 0.6rem; margin-left:-5px">
                                                    {{ $user->first_name }}
                                                </td>
