            ...
            <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                ...
                <div>
                    <div class="btn-wrapper" style="margin-top:5px">
                        ...
                        <a href="/dashboardF" class="btn btn-otline-dark">
...
<script>
    document.addEventListener('livewire:load', function() {
        ...
        var datasets = {!! json_encode($weeklySales) !!};
        ...
        datasets.forEach(function(dataset, index) {
            ...
            var saleData = dataset.data.map(function(data) {
                return data.sales;
            });
            var sale2Data = dataset.data.map(function(data) {
                return data.sales2;
            });
