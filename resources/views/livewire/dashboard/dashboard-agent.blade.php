                ...
                <div class="card">
                    ...
                    <div class="card-footer py-3"
                        ...
                        <div class="row align-items-center  justify-content-center" style="color:#4650dd ">
                            <div class="col-10">
                                <p class="mb-0">
                                    <a href="/customer/proposal" style="text-decoration: none;color: inherit;">En
                                        savoir
                                        plus</a></strong>
                                </p>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer py-3"
                        ...
                        <div class="row align-items-center justify-content-center text-success">
                            <div class="col-10">
                                <p class="mb-0">
                                    <a href="/proposal/all" style="text-decoration: none;color: inherit;">En
                                        savoir
                                        plus</a></strong>
                                </p>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer py-3"
                        ...
                        <div class="row align-items-center justify-content-center" style="color:#835db4">
                            <div class="col-10">
                                <p class="mb-0">
                                    <a href="/sales" style="text-decoration: none;color: inherit;">En
                                        savoir
                                        plus</a></strong>
                                </p>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer py-3"
                        ...
                        <div class="row align-items-center justify-content-center" style="color:#DC3545">
                            <div class="col-10">
                                <p class="mb-0">
                                    <a href="/profile/absence" style="text-decoration: none;color: inherit;">En
                                        savoir
                                        plus</a></strong>
                                </p>
                            </div>
