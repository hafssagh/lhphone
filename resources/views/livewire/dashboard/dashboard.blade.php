<ul class="navbar-nav">
    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
      <h3 class="text-muted fw-light">
        ...
        <i>&nbsp; En cours de construction ... </i></h3>
    </li>
  </ul>
<br><br>
<div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h3 style="color:#4650dd ">{{ $cards[0] }} Agents</h3>
                    ...
                    <div class="mb-4 col-sm-6 col-lg-3 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h3 class="text-danger">{{ $cards[1] }} Agents</h3>
                    ...
                    <div class="mb-4 col-sm-6 col-lg-3 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h3 style="color:#835db4">{{ $cards[3] }} Devis</h3>
                                        <p class="text-sm mb-0">En cours</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-3 ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="text-center" style="padding: 0.8rem;">{{ $user->totalAbsenceDays }}</td>
