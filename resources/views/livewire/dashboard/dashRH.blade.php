                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h3 style="color:#4650dd; font-size: 1.25rem">{{ $cards[0] }} Utilisateurs</h3>
                ...
                <div class="mb-4 col-sm-6 col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h3 class="text-danger" style="font-size: 1.25rem">{{ $cards[5] }} Départs</h3>
                                    <p class="text-sm mb-0">.</p>
                                </div>
                                <div class="flex-shrink-0 ms-3 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                        ...
                        <div class="card-footer py-3"
                            ...
                            <div class="row align-items-center justify-content-center text-danger">
                                <div class="col-10">
                                    <p class="mb-0">
                                        <strong><a href="/resignation" style="text-decoration: none;color: inherit;">En
                                                savoir
                                                plus</a></strong>
                                    </p>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer py-3"
                            ...
                            <div class="row align-items-center justify-content-center" style="color:#835db4">
                                <div class="col-10">
                                    <p class="mb-0">
                                        <strong><a href="/admin/list" style="text-decoration: none;color: inherit;">En
                                                savoir
                                                plus</a></strong>
                                    </p>
                                </div>
                            ...
                            @foreach ($stagiaire as $stage)
                                <div class="list-group-item px-0">
                                    <div class="row">
                                            ...
                                            <div class="avatar   me-2">
                                                <div
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="../assets/images/user2.png" class="rounded-circle "
                                        ...
                                        <div class="col">
                                            <span><strong class="text-dark"> {{ $stage->last_name }}
                                                    {{ $stage->first_name }}
                                                </strong></span>
                                            <div class="text-gray-500 small">
                                                {{ \Carbon\Carbon::parse($stage->created_at)->diffForHumans() }}</div>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
            ...
            <div class="card">
                <div class="card-body">
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h3 class="card-title card-title-dash">Anniversaire d'aujourd'hui ({{ $cards[7] }})
                ...
                <div class="card-body">
                    <div class="table">
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding: 0.8rem;">{{ $user->absenceHours }}
                                        </td>
                                        ...
                                        <td class="text-center" style="padding: 0.8rem;">{{ $user->challenge }}</td>
                        ...
                        <div class="float-end">
                            <br>
                            <div class="btn-group">
                                <button wire:click="$set('group', 1)" type="button" class="btn" style="background-color: #0d6efd; color:white">Groupe 1</button>
                                <button wire:click="$set('group', 2)" type="button" class="btn" style="background-color: #0d6efd; color:white">Groupe 2</button>
                                <button wire:click="$set('group', '3')" type="button" class="btn" style="background-color: #0d6efd; color:white">H2F</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($userCardre as $userCardre)
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding: 0.8rem;">{{ $userCardre->salary }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
