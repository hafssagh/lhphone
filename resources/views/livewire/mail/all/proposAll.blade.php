                    ...
                    <div class="ms-auto me-2">
                        <div class="home-tab">
                            <div class="btn-wrapper">
                                <a wire:click='exportPropo' class="btn btn-outline-dark me-0"><i class="icon-download"></i>
                                    Export</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <ul class="dropdown-menu" style="font-size: 13px" wire:model="selectedMonth" id="selectedMonth">
                            <li><a class="dropdown-item" href="#"
                                    wire:click="$set('selectedMonth', 'all')">Tous</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
                            ...
                            <li><a class="dropdown-item" href="#"
                                    wire:click="$set('selectedMonth', '03')">Mars</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
                                    wire:click="$set('selectedMonth', '04')">Avril</a>
                            </li>
                            <li><a class="dropdown-item" href="#" wire:click="$set('selectedMonth', '05')">Mai</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
                                    wire:click="$set('selectedMonth', '06')">Juin</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
                                    wire:click="$set('selectedMonth', '07')">Juillet</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
                                    wire:click="$set('selectedMonth', '08')">Août</a>
                            </li>
                            <li><a class="dropdown-item" href="#"
