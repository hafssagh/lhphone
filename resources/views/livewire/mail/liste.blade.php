                        ...
                        <div class="line">
                            ...
                            <div class="events">
                                @foreach ($mails as $mail)
                                    @if ($mail->created_at->format('H') == $hour)
                                        @if ($mail->state == '0')
                                            <div class="event" style="background-color: #ececec;">
                                            @elseif($mail->state == '1')
                                                <div class="event" style="background-color: #c8e6c9;">
                                                @elseif($mail->state == '-1')
                                                    <div class="event" style="background-color: #ffe2e0;">
                                        @endif
